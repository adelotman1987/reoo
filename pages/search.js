      ...
      <Grid sx={classes.section} container spacing={2}>
            ...
            <ListItem>
              <Box sx={classes.fullWidth}>
                ...
                <Select fullWidth value={category} onChange={categoryHandler}>
                  <MenuItem value="all">את כל</MenuItem>
                  {categories &&
        ...
        <Grid item md={9}>
          <Grid container justifyContent="space-between" alignItems="center">
            <Grid item>
              {products && products.length !== 0 ? products.length : 'אין'}{' '}
              תוצאות
            ...
            <Grid item>
              ...
              <Select value={sort} onChange={sortHandler}>
                ...
                <MenuItem value="lowest">מחיר מהנמוך לגבוה</MenuItem>
                <MenuItem value="highest">מחיר: גבוה עד נמוך</MenuItem>
                <MenuItem value="toprated">חוות דעת של לקוחות</MenuItem>
              </Select>
            </Grid>
          </Grid>
